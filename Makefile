...
# Automatically generated at Sun Jan 17 22:52:04 +0800 2010
...
obj:
	...
	mkdir -p obj/3rdparty/vnc_auth_des
	mkdir -p obj/src
	mkdir -p obj/test
	mkdir -p obj/xdk


api: 3rdparty/crypto/md5/md5.h 3rdparty/crypto/md5/md5.c 3rdparty/crypto/sha1/sha1.h 3rdparty/crypto/sha1/sha1.c 3rdparty/vnc_auth_des/d3des.h 3rdparty/vnc_auth_des/d3des.c 3rdparty/bigint/bigint.h 3rdparty/bigint/bigint.c src/vnc_proxy.c xdk/xhash.h xdk/xmemory.h xdk/xdef.c xdk/xkeepalive.h xdk/xhash.c xdk/xutils.c xdk/xcrypto.h xdk/xlog.h xdk/xnet.c xdk/xstr.c xdk/xvec.h xdk/xcrypto.c xdk/xutils.h xdk/xlog.c xdk/xmemory.c xdk/xnet.h xdk/xvec.c xdk/xkeepalive.c xdk/xbigint.c xdk/xbigint.h xdk/xstr.h xdk/xdef.h 
	doxygen
...
3rdparty: bin obj obj/3rdparty/crypto/md5/md5.o obj/3rdparty/crypto/sha1/sha1.o obj/3rdparty/vnc_auth_des/d3des.o obj/3rdparty/bigint/bigint.o
...
obj/3rdparty/vnc_auth_des/d3des.o: 3rdparty/vnc_auth_des/d3des.c 3rdparty/vnc_auth_des/d3des.h
	$(CC) $(CFLAGS) -c 3rdparty/vnc_auth_des/d3des.c -o obj/3rdparty/vnc_auth_des/d3des.o


obj/src/vnc_proxy.o: src/vnc_proxy.c xdk/xstr.h xdk/xnet.h xdk/xmemory.h xdk/xcrypto.h xdk/xutils.h 3rdparty/vnc_auth_des/d3des.h
	$(CC) $(CFLAGS) -c src/vnc_proxy.c -o obj/src/vnc_proxy.o

src: bin obj bin/vnc_proxy obj/src/vnc_proxy.o

bin/vnc_proxy: obj/src/vnc_proxy.o obj/xdk/xstr.o obj/xdk/xnet.o obj/xdk/xmemory.o obj/xdk/xcrypto.o obj/xdk/xutils.o obj/3rdparty/vnc_auth_des/d3des.o obj/xdk/xdef.o obj/3rdparty/crypto/md5/md5.o obj/3rdparty/crypto/sha1/sha1.o
	$(CC) $(CFLAGS) $(LDFLAGS) obj/src/vnc_proxy.o obj/xdk/xstr.o obj/xdk/xnet.o obj/xdk/xmemory.o obj/xdk/xcrypto.o obj/xdk/xutils.o obj/3rdparty/vnc_auth_des/d3des.o obj/xdk/xdef.o obj/3rdparty/crypto/md5/md5.o obj/3rdparty/crypto/sha1/sha1.o -o bin/vnc_proxy
