...
# Automatically generated at Sun Jan 17 14:08:07 +0800 2010
...
api: 3rdparty/crypto/md5/md5.h 3rdparty/crypto/md5/md5.c 3rdparty/crypto/sha1/sha1.h 3rdparty/crypto/sha1/sha1.c 3rdparty/bigint/bigint.h 3rdparty/bigint/bigint.c src/vnc_proxy.c xdk/xhash.h xdk/xmemory.h xdk/xdef.c xdk/xkeepalive.h xdk/xhash.c xdk/xutils.c xdk/xcrypto.h xdk/xlog.h xdk/xnet.c xdk/xstr.c xdk/xvec.h xdk/xcrypto.c xdk/xutils.h xdk/xlog.c xdk/xmemory.c xdk/xnet.h xdk/xvec.c xdk/xkeepalive.c xdk/xbigint.c xdk/xbigint.h xdk/xstr.h xdk/xdef.h 
	doxygen
...
3rdparty: bin obj obj/3rdparty/crypto/md5/md5.o obj/3rdparty/crypto/sha1/sha1.o obj/3rdparty/bigint/bigint.o
...
obj/src/vnc_proxy.o: src/vnc_proxy.c xdk/xnet.h
	$(CC) $(CFLAGS) -c src/vnc_proxy.c -o obj/src/vnc_proxy.o

src: bin obj bin/vnc_proxy obj/src/vnc_proxy.o

bin/vnc_proxy: obj/src/vnc_proxy.o obj/xdk/xnet.o obj/xdk/xmemory.o obj/xdk/xutils.o obj/xdk/xdef.o obj/xdk/xstr.o
	$(CC) $(CFLAGS) $(LDFLAGS) obj/src/vnc_proxy.o obj/xdk/xnet.o obj/xdk/xmemory.o obj/xdk/xutils.o obj/xdk/xdef.o obj/xdk/xstr.o -o bin/vnc_proxy
