...
# Automatically generated at Mon Jan 25 15:18:40 +0800 2010
...
obj/src/vnc_proxy.o: src/vnc_proxy.c xdk/xstr.h xdk/xnet.h xdk/xvec.h xdk/xmemory.h xdk/xcrypto.h xdk/xutils.h xdk/xlog.h 3rdparty/vnc_auth/d3des.h
...
bin/vnc_proxy_ctl: obj/src/vnc_proxy_ctl.o obj/xdk/xdef.o obj/xdk/xmemory.o obj/xdk/xutils.o obj/xdk/xstr.o obj/xdk/xcrypto.o obj/xdk/xsys.o obj/3rdparty/crypto/md5/md5.o obj/3rdparty/crypto/sha1/sha1.o
	$(CC) $(CFLAGS) $(LDFLAGS) obj/src/vnc_proxy_ctl.o obj/xdk/xdef.o obj/xdk/xmemory.o obj/xdk/xutils.o obj/xdk/xstr.o obj/xdk/xcrypto.o obj/xdk/xsys.o obj/3rdparty/crypto/md5/md5.o obj/3rdparty/crypto/sha1/sha1.o -o bin/vnc_proxy_ctl

bin/vnc_proxy: obj/src/vnc_proxy.o obj/xdk/xstr.o obj/xdk/xnet.o obj/xdk/xvec.o obj/xdk/xmemory.o obj/xdk/xcrypto.o obj/xdk/xutils.o obj/xdk/xlog.o obj/3rdparty/vnc_auth/d3des.o obj/xdk/xdef.o obj/3rdparty/crypto/md5/md5.o obj/3rdparty/crypto/sha1/sha1.o obj/xdk/xsys.o obj/xdk/xoption.o obj/xdk/xhash.o
	$(CC) $(CFLAGS) $(LDFLAGS) obj/src/vnc_proxy.o obj/xdk/xstr.o obj/xdk/xnet.o obj/xdk/xvec.o obj/xdk/xmemory.o obj/xdk/xcrypto.o obj/xdk/xutils.o obj/xdk/xlog.o obj/3rdparty/vnc_auth/d3des.o obj/xdk/xdef.o obj/3rdparty/crypto/md5/md5.o obj/3rdparty/crypto/sha1/sha1.o obj/xdk/xsys.o obj/xdk/xoption.o obj/xdk/xhash.o -o bin/vnc_proxy


obj/xdk/xhash.o: xdk/xhash.c xdk/xhash.h xdk/xmemory.h xdk/xdef.h
	$(CC) $(CFLAGS) -c xdk/xhash.c -o obj/xdk/xhash.o

obj/xdk/xlog.o: xdk/xlog.c xdk/xlog.h xdk/xoption.h xdk/xutils.h xdk/xsys.h xdk/xdef.h
...
obj/xdk/xutils.o: xdk/xutils.c xdk/xmemory.h xdk/xutils.h xdk/xcrypto.h xdk/xsys.h xdk/xdef.h xdk/xstr.h
	$(CC) $(CFLAGS) -c xdk/xutils.c -o obj/xdk/xutils.o

obj/xdk/xkeepalive.o: xdk/xkeepalive.c xdk/xkeepalive.h xdk/xutils.h xdk/xdef.h xdk/xlog.h
	$(CC) $(CFLAGS) -c xdk/xkeepalive.c -o obj/xdk/xkeepalive.o

obj/xdk/xnet.o: xdk/xnet.c xdk/xnet.h xdk/xmemory.h xdk/xutils.h xdk/xlog.h xdk/xdef.h xdk/xstr.h
	$(CC) $(CFLAGS) -c xdk/xnet.c -o obj/xdk/xnet.o

obj/xdk/xoption.o: xdk/xoption.c xdk/xoption.h xdk/xmemory.h xdk/xstr.h xdk/xvec.h xdk/xhash.h xdk/xutils.h xdk/xdef.h
...
xdk: bin obj obj/xdk/xdef.o obj/xdk/xhash.o obj/xdk/xutils.o obj/xdk/xsys.o obj/xdk/xnet.o obj/xdk/xstr.o obj/xdk/xoption.o obj/xdk/xconf.o obj/xdk/xcrypto.o obj/xdk/xlog.o obj/xdk/xmemory.o obj/xdk/xvec.o obj/xdk/xkeepalive.o obj/xdk/xbigint.o

obj/xdk/xconf.o: xdk/xconf.c xdk/xconf.h xdk/xmemory.h xdk/xutils.h xdk/xdef.h xdk/xstr.h xdk/xhash.h
